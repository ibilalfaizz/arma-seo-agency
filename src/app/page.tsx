  ...
  return (
    <main className="min-h-screen bg-primary-dark">
      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        {/* Hero Section - ARMA Style */}
        <div className="text-center mb-12">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="inline-block relative -z-11">
              FREE SEO
              <Image
                src={shapeSvg}
                alt=""
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-10">
            <div className="flex items-center gap-3 text-gray-300">
              ...
              <span className="text-lg font-medium">Blazing Fast</span>
            </div>
            <div className="flex items-center gap-3 text-gray-300">
            ...
            <div className="flex items-center gap-3 text-gray-300">
              ...
              <span className="text-lg font-medium">Trusted by 500+ Businesses</span>
            </div>
          </div>
        </div>
